...
export class SeederService implements OnApplicationBootstrap {
  constructor() {} // private roomInventoryModel: Model<RoomInventoryDocument>, // @InjectModel(RoomInventoryDocument.name) // private priceModel: Model<PriceDocument>, // @InjectModel(PriceDocument.name) // private amenityModel: Model<AmenityDocument>, // @InjectModel(AmenityDocument.name) // private roomtypeModel: Model<RoomTypeDocument>, // @InjectModel(RoomTypeDocument.name)
